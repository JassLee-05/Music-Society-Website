...
<html lang="en">
    <head>
        <title>View Event Feedback</title>
        ...
        <div class="container">
                ...
                if (mysqli_num_rows($result_fetchFeedback) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result_fetchFeedback)) {
                        ...
                        echo "<td>" . $row["venue_setup"] . "</td>";
                        echo "<td>" . $row["event_informativeness"] . "</td>";
                        echo "<td>" . $row["attend_future"] . "</td>";
                        echo "<td>" . $row["most_liked"] . "</td>";
